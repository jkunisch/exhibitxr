...
## Now
- [x] Phase 1.1 (Claude): Next.js scaffold + dependencies
- [x] Phase 1.1 (Claude): `schema.ts` + Firebase init + validation
- [x] Phase 1.2 (Claude): Viewer + embed route
...
## Later
- [ ] Phase 3: AI chat + skybox
- [ ] Phase 4: Stripe + limits + analytics
- [ ] Phase 5: launch polish + legal
