  ...
  return (
    <nav
      className={`fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl transition-all duration-500 ${
        isScrolled 
          ? "bg-zinc-900/60 backdrop-blur-2xl border border-white/15 py-3 rounded-full shadow-2xl" 
          : "bg-white/[0.03] backdrop-blur-md border border-white/10 py-5 rounded-full"
      }`}
    >
